  ...
  return (
    <div className='flex justify-between items-center py-10'>
      ...
      <ul className='flex list-none gap-[20px] text-lg items-center'>
        ...
        <li onClick={() => {setMenu("contact-us")}} className={`hover:text-red-300 cursor-pointer ${menu==="contact-us" ? "border-b-red-300 text-red-300 " : ""}`}><a href="#contact-us">Contact Us</a></li>
      </ul>
