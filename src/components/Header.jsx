...
const Header = () => {
  return (
    <div id="explore-start" className='h-[34vw] my-5 mx-auto relative rounded-xl' style={{ background: "url(" + assets.header_img + ")", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
